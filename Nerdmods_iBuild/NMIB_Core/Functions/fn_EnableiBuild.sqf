...
NMIB_ClassName = if ((_this select 0) isEqualType "") then {(_this select 0);} else {typeOf (_this select 0);};
NMIB_RelocateObj = if (!((_this select 0) isEqualType "")) then {(_this select 0);};
