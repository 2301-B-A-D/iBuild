...
_Object addAction ["<t color='#FF974D'>Save Structures</t>", {[_Object] call db_fnc_updateobject;}, nil,0,false,true,"","(missionNamespace getVariable 'NMIB_Workbench') == (position player) nearestObject 'NMIB_Plot_Workbench';"];